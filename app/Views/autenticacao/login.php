      ...
      <main>
        ...
        <form action="login/logar" method="post">
          <div class="input-wrapper">
            ...
            <input value="<?= old('email') ?>" id="email" type="email" name="email" pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)+$" required placeholder="Digite seu e-mail" />
          ...
          <div class="input-wrapper">
            <div class="label-wrapper">
              ...
              <a href="<?= url_to('novaSenha') ?>">Esqueceu a senha?</a>
            </div>
            ...
            <img onclick="tooglePassword()" class="eye" id="eye" src="<?= base_url('assets/images/eyes/eye-off.svg') ?>" alt="" />
            <img onclick="tooglePassword()" class="eye hide" id="eye-hide" src="<?= base_url('assets/images/eyes/eye.svg') ?>" alt="" />
          </div>
